...
use Models\SiteMembersStatisticsModel;
...
class SiteMembersLogic extends AbstractLogic
{
    ...
    /**
     * @var SiteMembersStatisticsModel
     */
    protected $SiteMembersStatistics = null;
    ...
    protected function getModel()
    {
        ...
        $this->SiteMembersStatistics = SiteMembersStatisticsModel::getInstance();
    ...
    {
        $siteMembers = $this->SiteMembers->getAllJoinStatistics();
        return $siteMembers;
    }
...
//		vD($result);
    ...
    public function insertStatistics($site_members_id, $article_count, $max_vote_scpjp_id, $average_vote, $recent_site_activity_id)
    {
        return $this->SiteMembersStatistics->insert($site_members_id, $article_count, $max_vote_scpjp_id, $average_vote, $recent_site_activity_id);
    }

    public function updateStatistics($id, $site_members_id, $article_count, $max_vote_scpjp_id, $average_vote, $recent_site_activity_id)
    {
        return $this->SiteMembersStatistics->update($id, $site_members_id, $article_count, $max_vote_scpjp_id, $average_vote, $recent_site_activity_id);
    }

    public function getStatistics($id)
    {
        $result = $this->SiteMembersStatistics->get($id);
        return $result[0];
    }
}